...
<html lang="hr">
    ...
    <meta name="description" content="Vježba 8 - forma, petlje">   
    ...
    <style>
     ...
     <body>
        <main class="card_wrap">
            ...
            <form method="POST" action="vjezba8.php">
                <label>Označi vozilo</label>
                <?php 
                    foreach ($cars as $car){
                        echo "<label><input type='radio' id='$car' value='$car' name='selected' required> $car</label>";
                    }
                ?>
