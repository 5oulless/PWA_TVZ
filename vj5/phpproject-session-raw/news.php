<?php 
	...
	if (!isset($action)) {
		...
		if ($action == 1) {
			...
			# inicijalizacija sjednice
			$_SESSION["news_title_2"] ="Tech firm surge pushes US markets higher";
			$link = 'index.php?menu=' . $menu . '&action=2';
			...
			$link = 'index.php?menu=' . $menu . '&action=3';
			$_SESSION["news_link_3"] = $link;
			print '
