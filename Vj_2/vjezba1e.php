...
$varijabla_a = isset($_GET["var_a"]) ? $_GET["var_a"] : 0;
$varijabla_b = isset($_GET["var_b"]) ? $_GET["var_b"] : 0;
$varijabla_c = NULL;

    if(!(empty($varijabla_a) || empty($varijabla_b))):
    $varijabla_c = (3*$varijabla_a - $varijabla_b) / 2;
    endif;
...
<html>
    ...
    <meta name="description" content="Vježba 1e - forma, izbor teme i slike.">   
    ...
    <body>
        <main class="card_wrap">
            ...
            <?php endif ?>
            <form method="get" action="vjezba1e.php">
                <fieldset>
                ...
                <label>Varijabla A: <input type="number" name="var_a"></label>
                <label>Varijabla B: <input type="number" name="var_b"></label>
                <?php if (isset($varijabla_c)): ?>
                    <p>Vrijednost funkcije je: <?php echo $varijabla_c?></p>
                <?php endif ?>

                <div class="row">
                    <button class="btn" type="submit">Primjeni odabir</button>
                    <a class="btn" href="<?php echo htmlspecialchars($linkNatrag)?>" target="_blank">Natrag na vježba 1d</a>
                </div>
